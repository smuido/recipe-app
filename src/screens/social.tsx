...
interface MealPlannerScreenProps {
  ...
  onAddMealToDay: (day: string, recipeId: string) => void;
...
export function MealPlannerScreen({
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.body}>Add recipes to each day of the week, then check Pantry for your shopping list.</Text>
                  ...
                  recipes.map((recipe) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        onPress={() => onAddMealToDay(day, recipe.id)}
                      >
                        <View style={styles.mealTextWrap}>
